...
public class Player {
     ...
     */
    public Player(String playerName){this.playerName = playerName; this.level=1;}
     ...
     */
    public Player(String playerName, int level){this.playerName = playerName; this.level = level;}
